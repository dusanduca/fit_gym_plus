...
export const programs = [
    {
        ...
        icon: <SiOpenaigym />,
        title: "Program One",
        info: "Training program - Each personality is a world unto itself, with its own needs, aspirations and goals.",
        path: "/programs/111"
    },
    {
        id: 2,
...
export const values = [
    {
        ...
        icon: <SiOpenaigym />,
        title: "Value One",
        desc: "Health, nutrition and exercise are an important part of everyday life."
    },
    {
        id: 2,
        icon: <SiOpenaigym />,
